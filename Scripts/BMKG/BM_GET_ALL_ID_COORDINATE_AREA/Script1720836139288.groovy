...
// #1 Get all area id information
def areaIds = xmlResponse.forecast.area*.@id
println("Area IDs: " + areaIds)

// #2 Get coordinate
def coordinates = xmlResponse.forecast.area*.@coordinate
println("Coordinates: " + coordinates)

// #3 Get domain
def domains = xmlResponse.forecast.area*.@domain
