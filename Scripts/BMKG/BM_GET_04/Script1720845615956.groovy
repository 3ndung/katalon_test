...
// Validate the presence of multiple Area IDs
def targetAreaIds = ['501397', '501164', '501174']
targetAreaIds.each { targetId ->
	assert areaIds.contains(targetId)
	println("Area ID '${targetId}' is present in the response.")
}
