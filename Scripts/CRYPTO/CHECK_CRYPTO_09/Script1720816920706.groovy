...
try {
	...
	def checkNotNullOrEmpty = { field ->
		field != null && !field.toString().isEmpty()
	}

	if (jsonResponse.bpi.USD) {
		assert checkNotNullOrEmpty(jsonResponse.bpi.USD.code)
		assert checkNotNullOrEmpty(jsonResponse.bpi.USD.rate_float)
